        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if (list.isEmpty()) {
                ...
                notification = mBuilder
                        ...
                        .setContentText("Image saved at Downloads/JRM/" + sender_name)
                        .build();

                notificationManager.notify(0, notification);
                Toasty.success(ctxt, "Image saved at Downloads/JRM/" + sender_name, Toasty.LENGTH_LONG,true).show();
            }
        }
       ...
       new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        ...
                        request.setTitle("JRM");
                        request.setDescription("Downloading image...");
                        request.setVisibleInDownloadsUi(true);
                        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "/JRM Images/"+sender_name  + "/HFY_" +  System.currentTimeMillis() + ".jpeg");
