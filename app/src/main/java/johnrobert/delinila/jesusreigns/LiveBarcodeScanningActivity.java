...
import johnrobert.delinila.jesusreigns.barcodedetection.BarcodeProcessor;
import johnrobert.delinila.jesusreigns.barcodedetection.BarcodeResultFragment;
import johnrobert.delinila.jesusreigns.camera.CameraSource;
import johnrobert.delinila.jesusreigns.camera.CameraSourcePreview;
...
import johnrobert.delinila.jesusreigns.settings.SettingsActivity;
...
public class LiveBarcodeScanningActivity extends AppCompatActivity implements OnClickListener {
  ...
  private void setUpWorkflowModel() {
    ...
    workflowModel.workflowOutput.observe(this, stringObjectMap -> {
      String barcode = stringObjectMap.get("detectedBarcode");
      String error = stringObjectMap.get("error");
      BarcodeResultFragment.show(getSupportFragmentManager(), barcode, error);
    });
