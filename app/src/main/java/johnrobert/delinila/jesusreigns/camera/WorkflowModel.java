...
package johnrobert.delinila.jesusreigns.camera;
...
import johnrobert.delinila.jesusreigns.objectdetection.DetectedObject;
import johnrobert.delinila.jesusreigns.productsearch.Product;
import johnrobert.delinila.jesusreigns.productsearch.SearchEngine.SearchResultListener;
import johnrobert.delinila.jesusreigns.productsearch.SearchedObject;
...
public class WorkflowModel extends AndroidViewModel implements SearchResultListener {
  ...
  public final MutableLiveData<Map<String, String>> workflowOutput = new MutableLiveData<>();
