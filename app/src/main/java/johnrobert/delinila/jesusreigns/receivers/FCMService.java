...
public class FCMService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        Log.d("FCM_LOGIC", "NOTIFICATION RECIEVED");
    ...
    private void handleDataMessage(RemoteMessage remoteMessage) {
        ...
        switch (click_action) {
            ...
            case "SHOW COMMUNITY":
                Log.d("TARGET_FORUM", "onMessageReceived: " + click_action);
                resultIntent = new Intent(getApplicationContext(), ApproveActivity.class);
        ...
        try {
            ...
            Log.d("FCM_LOGIC", foreground ? "FOREGROUND" : "NOT FOREGROUND");
