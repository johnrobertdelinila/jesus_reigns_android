...
public class Config {
    ...
    public static void createNotificationChannels(Context context){
        ...
        flash_message_channel.setSound(Uri.parse("android.resource://"+context.getPackageName()+"/"+ R.raw.jrm_sound), null);
        ...
        comments_channel.setSound(Uri.parse("android.resource://"+context.getPackageName()+"/"+ R.raw.jrm_sound), null);
        ...
        like_channel.setSound(Uri.parse("android.resource://"+context.getPackageName()+"/"+ R.raw.jrm_sound), null);
        ...
        forum_channel.setSound(Uri.parse("android.resource://"+context.getPackageName()+"/"+ R.raw.jrm_sound), null);
        ...
        hify_other_channel.setSound(Uri.parse("android.resource://"+context.getPackageName()+"/"+ R.raw.jrm_sound), null);
